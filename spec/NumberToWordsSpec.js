describe("convert a give number of words", function () {
  ...
  it("converts numbers to words", function () {
    ...
    expect("nine hundred ninety nine").toEqual(
      numberToWordConverter.convert(999)
    );
    ...
    expect("one thousand one hundred eleven").toEqual(
      numberToWordConverter.convert(1111)
    );
    ...
    expect("nine thousand nine hundred ninety nine").toEqual(
      numberToWordConverter.convert(9999)
    );
    expect("ten thousand").toEqual(numberToWordConverter.convert(10000));
    expect("ten thousand nine hundred ninety nine").toEqual(
      numberToWordConverter.convert(10999)
    );
  });
});
